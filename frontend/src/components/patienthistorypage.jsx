...
const stepActiveCheck = '/assets/historyIcon.svg'
const stepLifestyle = '/assets/lifestyleIcon.svg'
const stepBiometrics = '/assets/biometricsIcon.svg'
const stepSummary = '/assets/summaryIcon.svg'
const completeBadge = '/assets/ompleteIcon.svg'
const medicalIcon = '/assets/medicalIcon.svg'
const familyIcon = '/assets/familyIcon.svg'
const medsIcon = '/assets/medsIcon.svg'
const addIcon = '/assets/addIcon.svg'
const lifestyleIcon = '/assets/lifestyleIcon1.svg'
const reportsIcon = '/assets/reportsIcon.svg'
const uploadIcon = '/assets/uploadIcon.svg'
