...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* HERO */}
      {/* <section className="pt-24 pb-16 px-4 sm:px-6 max-w-5xl mx-auto">
        <div className="max-w-2xl">
          ...
          <h1 className="text-[40px] sm:text-[44px] font-bold text-[#1f2937] leading-[1.1] mb-5">
            Know Your Metabolic Risk.{" "}
            <span className="text-blue-600">Control Diabetes Before It Progresses</span>{" "}
            Or Start Reversing It Naturally.
          </h1>
          <p className="text-gray-500 text-sm max-w-xl mb-7 leading-relaxed">
            Get a personalized Glynostic Metabolic Intelligence Report that reveals your metabolic age,
          ...
          <button className="bg-blue-600 text-white font-semibold px-6 py-2.5 rounded-md text-xs hover:bg-blue-700 transition-all shadow-md shadow-blue-200">
            Get Your Report at ₹699
          </button>
        </div>
      </section> */}
